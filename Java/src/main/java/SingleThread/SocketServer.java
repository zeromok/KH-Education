package Java.src.main.java.SingleThread;
...
//		--------------------------
        ...
        try (serverSock) {    // try-with-resources block
            ...
            while (true) {    // Infinite loop
                ...
                System.out.println("---------------------------------------------------------------------");
                System.out.println("2. listening on port and addr  ..." + listenPort + " and " + serverSock.getInetAddress());
                System.out.println("---------------------------------------------------------------------");

//                serverSock.setSoTimeout(0);                            // Infinitely wait for incoming connection.
